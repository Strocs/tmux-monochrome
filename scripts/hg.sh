...
IFS=' ' read -r -a hide_status <<<$(get_tmux_option "@strocs-hg-disable-status" "false")
IFS=' ' read -r -a current_symbol <<<$(get_tmux_option "@strocs-hg-show-current-symbol" "✓")
IFS=' ' read -r -a diff_symbol <<<$(get_tmux_option "@strocs-hg-show-diff-symbol" "!")
IFS=' ' read -r -a no_repo_message <<<$(get_tmux_option "@strocs-hg-no-repo-message" "")
IFS=' ' read -r -a no_untracked_files <<<$(get_tmux_option "@strocs-hg-no-untracked-files" "false")
