...
HOSTS=$(get_tmux_option "@strocs-network-hosts" "google.com github.com example.com")
wifi_label=$(get_tmux_option "@strocs-network-wifi-label" "")
ethernet_label=$(get_tmux_option "@strocs-network-ethernet-label" "Ethernet")
...
main() {
  network="$(get_tmux_option "@strocs-network-offline-label" "Offline")"
